...
当前界面风格保留红色渐变电影节质感，但封面生成会按文案内容自动拆出 5 个不同视觉方向，不再把所有图片固定成同一种红黑模板。

## 当前能力

- 支持粘贴文案
- 支持上传 `.txt`、`.md`、`.docx`
- 支持上传 PNG / JPG / WEBP 参考图，用于参考配色、质感和版式
- 支持 18 个预设封面风格，例如手绘边框、分屏标签、职场卡片、胶片票根
- 支持 7 种字体风格，并可手动填写封面主标题、副标题、小字、贴纸、图片比例和其他要求
- 支持批量模式：围绕同一个预设风格生成 5 张不同变体
- `.doc`、PDF、视频在 v1 暂不支持，会给出提示
- DeepSeek 生成封面主标题、封面副标题、发布标题、正文、话题、5 个封面提示词
- Image2 / BananaRouter 生成 5 个不同版式和风格的封面版本；有参考图时走图片参考生成
